...
async def criar_schema_compras():
    ...
    try:
        ...
        await ajard_query("""
            ALTER TABLE compras.oc_itens
              ADD COLUMN IF NOT EXISTS qtd_devolvida NUMERIC(12,3) DEFAULT 0""", fetch="none")
        await ajard_query("""
            ALTER TABLE compras.ordens_compra
        ...
        await ajard_query("""
            ALTER TABLE compras.ordens_compra
              ADD COLUMN IF NOT EXISTS fornecedor_avulso_contato TEXT""", fetch="none")
        await ajard_query("""
